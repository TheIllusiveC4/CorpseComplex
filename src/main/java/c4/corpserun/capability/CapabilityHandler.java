...
public class CapabilityHandler {
    ...
    public static final ResourceLocation DEATH_INV_CAP = new ResourceLocation(CorpseRun.MODID,"deathInventory");
    ...
    public void attachCapability(AttachCapabilitiesEvent e) {
        ...
        e.addCapability(DEATH_INV_CAP, new DeathInventoryProvider());
    }
