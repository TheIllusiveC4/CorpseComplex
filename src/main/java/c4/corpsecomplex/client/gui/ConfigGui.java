...
public class ConfigGui extends GuiConfig {
  ...
  public ConfigGui(GuiScreen parentScreen) {
    super(parentScreen, getConfigElements(), CorpseComplex.MODID, false, false,
            CorpseComplex.MODNAME);
  }

  private static List<IConfigElement> getConfigElements() {
    List<IConfigElement> list = new ArrayList<IConfigElement>();

    list.add(new ConfigElement(ModuleHelper.cfg.getCategory("Inventory"))
            .listCategoriesFirst(false));
    list.add(new ConfigElement(ModuleHelper.cfg.getCategory("Experience")));
    list.add(new ConfigElement(ModuleHelper.cfg.getCategory("Effects"))
            .listCategoriesFirst(false));
    ...
    if (Loader.isModLoaded("toughasnails")) {
      list.add(new ConfigElement(
              ModuleHelper.cfg.getCategory("Tough as Nails")));
    }
