...
public class DeathInventory implements IDeathInventory {
  ...
  public static class Provider implements ICapabilitySerializable<NBTBase> {
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
      return capability == DEATH_INV_CAP ? DEATH_INV_CAP.<T>cast(
              this.instance) : null;
    }

    @Override
    public NBTBase serializeNBT() {
      return DEATH_INV_CAP.getStorage().writeNBT(DEATH_INV_CAP, this.instance,
              null);
    }

    @Override
    public void deserializeNBT(NBTBase nbt) {
      DEATH_INV_CAP.getStorage().readNBT(DEATH_INV_CAP, this.instance, null,
              nbt);
    }
  }
  ...
  public static class Storage implements Capability.IStorage<IDeathInventory> {
    ...
    @Override
    public NBTBase writeNBT(Capability<IDeathInventory> capability,
            IDeathInventory instance, EnumFacing side) {

      return instance.getDeathInventory();
    }

    @Override
    public void readNBT(Capability<IDeathInventory> capability,
            IDeathInventory instance, EnumFacing side, NBTBase nbt) {
