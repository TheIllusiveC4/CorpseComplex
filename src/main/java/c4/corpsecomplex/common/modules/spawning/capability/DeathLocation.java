...
public class DeathLocation implements IDeathLocation {
  ...
  public static class Provider implements ICapabilitySerializable<NBTBase> {
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing facing) {
      return capability == DEATH_LOC_CAP ? DEATH_LOC_CAP.<T>cast(
              this.instance) : null;
    }

    @Override
    public NBTBase serializeNBT() {
      return DEATH_LOC_CAP.getStorage().writeNBT(DEATH_LOC_CAP, this.instance,
              null);
    }

    @Override
    public void deserializeNBT(NBTBase nbt) {
      DEATH_LOC_CAP.getStorage().readNBT(DEATH_LOC_CAP, this.instance, null,
              nbt);
    }
  }
  ...
  public static class Storage implements Capability.IStorage<IDeathLocation> {
    ...
    @Override
    public NBTBase writeNBT(Capability<IDeathLocation> capability,
            IDeathLocation instance, EnumFacing side) {
    ...
    @Override
    public void readNBT(Capability<IDeathLocation> capability,
            IDeathLocation instance, EnumFacing side, NBTBase nbt) {
      ...
      if (compound.getBoolean("hasDeathLocation")) {
        ...
        instance.setDeathLocation(
                new BlockPos(compound.getInteger("x"), compound.getInteger("y"),
