...
public class RecipeScroll extends ShapelessOreRecipe {
    ...
    public RecipeScroll() {
        super(null, NonNullList.from(Ingredient.EMPTY, Ingredient.fromItem(Items.PAPER), Ingredient.fromItem(Items.ENDER_PEARL), Ingredient.fromItem(Items.ROTTEN_FLESH)), new ItemStack(SpawningModule.scroll));
    }
}
