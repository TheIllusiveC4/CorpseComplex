...
public class ThutModule extends Submodule {
  ...
  public void loadModuleConfig() {
    keepThut = getBool("Keep Thut Wearables", false,
            "Set to true to keep Thut Wearables on death", false);
  }
  ...
  private static void updateClientThut(EntityPlayer player) {
    ...
    ThutWearables.packetPipeline.sendTo(new PacketSyncWearables(player),
